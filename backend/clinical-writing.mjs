...
role or speaker identity only when explicitly established in the source. Otherwise use neutral wording
such as "the patient reported", "the report states" or "the transcript records a plan", as supported.
