...
`BookingRequest`: id/visitID/clinic/phone/reason/earliest/latest/timeZone/preferences/status/scenario/createdAt/confirmedVisitID(optional). Status: draft/queued/calling/proposed/confirmed/needsUser/failed. No actual telephone call without future provider configuration.
