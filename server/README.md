...
| --- | --- | --- |
| Document or appointment transcript summary / visit preparation | `GEMINI_API_KEY`; optional `GEMINI_MODEL` | `POST /v1/ai/summarize`, `POST /v1/ai/prepare` |
